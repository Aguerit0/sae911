  ...
  <main id="main" class="main">
    ...
    <div class="card w-75 pt-3">
      <div class="card-body">
        ...
        <ul class="list-group">
            <li class="list-group-item fw-bold">Comisaria: </li>
            <li class="list-group-item fw-bold">Fecha: </li>
            <li class="list-group-item fw-bold">Turno: </li>
            <li class="list-group-item fw-bold">Superior de turno: </li>
            <li class="list-group-item fw-bold">Oficial servicio: </li>
            <li class="list-group-item fw-bold">Cant. de personal de guardia: </li>
            <li class="list-group-item fw-bold">Motoristas: </li>
            <li class="list-group-item fw-bold">Mov. en funcionamiento: </li>
            <li class="list-group-item fw-bold">Mov. fuera de servicio: </li>
            <li class="list-group-item fw-bold">Cant. detenidos causa federal: </li>
            <li class="list-group-item fw-bold">Cant. detenidos justicia ordinaria: </li>
            <li class="list-group-item fw-bold">Arrestados averiguacion del hecho: </li>
            <li class="list-group-item fw-bold">Cant. aprehendidos: </li>
            <li class="list-group-item fw-bold">Arrestados averiguacion actividades: </li>
            <li class="list-group-item fw-bold">Arrestados inf. codigo de faltas: </li>
            <li class="list-group-item fw-bold">Demorados: </li>
        </ul>
