<?php 
    ...
    if (isset($_POST['guardarIngresoPersonas'])) {
        $fecha_hora_reg = $_POST['fecha_hora_reg'];
        $tipo= $_POST['tipo'];
                ...
                <div class="card">
                  <div class="card-body">    
                    ...
                    <div class="col-md-6">
                        ...
                        <input require type="datetime-local" class="form-control" id="fecha_hora_reg" name="fecha_hora_reg" value="<?php echo $fecha_hora_reg?>">
                      </div>
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select required id="subtipo" name="subtipo" class="form-select"></select>
                    </div>
                      <div class="col-md-6">
                        <label for="dispuesto_por" class="form-label">Dispuesto Por</label>
                        <input require type="text" class="form-control" id="dispuesto_por" name="dispuesto_por" value="<?php echo $dispuesto_por?>">
                      </div>
                      <div class="col-md-6">
                        <label for="fecha_hora_ingreso" class="form-label">Fecha y Hora de Ingreso</label>
                        <input require type="datetime-local" class="form-control" id="fecha_hora_ingreso" name="fecha_hora_ingreso" value="<?php echo $fecha_hora_ingreso?>">
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <input require type="text" class="form-control" id="secuestro" name="secuestro" value="<?php echo $secuestro?>">
                      </div>
                      <div class="col-md-6">
                        <label for="elem_secuestrado" class="form-label">Elemento Secuestrado</label>
                        <input require type="text" class="form-control" id="elem_secuestrado" name="elem_secuestrado" value="<?php echo $elem_secuestrado?>">
                      </div>
