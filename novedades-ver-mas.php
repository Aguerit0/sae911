...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card w-75 pt-3">
      <div class="card-body">
          <ul class="list-group">
          <li class="list-group-item fw-bold">ID Novedades: <span class="fw-normal ms-2"><?php echo $idNovedades ?></span></li>
            ...
            <li class="list-group-item fw-bold">Eliminado: <span class="fw-normal ms-2"><?php echo $eliminado ?></span></li>
